...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="en"><body><Motion/><div id="site-content"><SiteHeader/>{children}<SiteFooter/></div></body></html>}
