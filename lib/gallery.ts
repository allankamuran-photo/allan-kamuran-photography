...
export function categoryPhotos(category:string):Photograph[]{const own=(originals as Photograph[]).filter(p=>p.category===category);return sortPhotos(own);}
